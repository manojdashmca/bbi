            ...
            <div class="col-xl-2 col-md-6">
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Total Segment</span>
                                <h4 class="mb-3">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-12">
                                ...
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="<?= $topdata['totalcategory'] ?>">0</span>
                                </h4>
                            </div>
            ...
            <div class="col-xl-2 col-md-6">
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Total Sub Category</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="<?= $topdata['totalsubcategory'] ?>">0</span>
                                </h4>
                            </div>
            ...
            <div class="col-xl-2 col-md-6">
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Total Member</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="<?= $topdata['totalmember'] ?>">0</span>
                                </h4>
                            </div>
