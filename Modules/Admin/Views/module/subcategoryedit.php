            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Category Add Form</h4>
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <form name="moduleadd" id="moduleadd" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="encsubcategoryid" value="<?=$encsubcategoryid?>"/>
                                <div class="row">
                                    <div class="row">
                                            ...
                                            <div class="form-group  mb-3">
                                                ...
                                                <select class="form-control form-select" id="segment" name="segment" onchange="getSegmentByCategory();">
                                                    ...
                                                    <?php foreach ($segment as $segmentdata) { ?>
                                                        <option value="<?= $segmentdata->segment_id ?>" <?=($subcategorydetail->segment_id_segment== $segmentdata->segment_id)?'selected="selected"':''?>><?= $segmentdata->segment_name ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>                                  
                                            ...
                                            <div class="form-group  mb-3">
                                                ...
                                                <select class="form-control form-select" id="category" name="category">
                                                    ...
                                                    <?php foreach ($category as $categorydata) { ?>
                                                        <option value="<?= $categorydata->category_id ?>" <?=($subcategorydetail->category_id_category== $categorydata->category_id)?'selected="selected"':''?>><?= $categorydata->category_name ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>                                  
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">                                    
                                            <div class="form-group  mb-3">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="<?=$subcategorydetail->sub_category_name?>">
                                            </div>                                  
