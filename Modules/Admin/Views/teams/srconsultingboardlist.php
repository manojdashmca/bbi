        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Sr Consulting And Advisory Board List</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Teams</a></li>
                            <li class="breadcrumb-item active">Sr Consulting And Advisory Board List</li>
                        </ol>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                                    <div class="mb-3">                                        
                                        ...
                                        <?php if (in_array(24, session()->get('accesscontrols'))) { ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Member To Sr Consulting and Advisory Board</h5>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="row">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="hidden" id="table" name='table' value='team_sr_consulting_board'/>
